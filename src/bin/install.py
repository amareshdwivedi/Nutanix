...
libs=['HealthCheck-1.0.0-py2.7.egg']
...
lines=['import os,sys',
'executable_path=os.path.dirname(__file__)+os.path.sep+"HealthCheck-1.0.0-py2.7.egg"+os.path.sep+"src"+os.path.sep+"health_check.pyc "',
'os.system(executable_path+ " ".join(sys.argv[1:]))']
